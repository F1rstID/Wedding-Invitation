...
function onClickedImageUpload() {
    ...
    imageInputElement.addEventListener("change", (e) => {
        ...
        // console.log(document.getElementById('main-img-input-file').localName)
...
function editSave() {
    ...
    console.log("#1", mainTitle);
    // console.log("#1!!!!", imagePath.style.backgroundImage);
    console.log("#1", groomName);
    console.log("#1", brideName);
    console.log("#1", weddingDate);
    console.log("#1", weddingHallDetailLocation);

    console.log("#2", invitationParases);
    console.log("#2", groomFatherName);
    console.log("#2", groomMotherName);
    console.log("#2", brideFatherName);
    console.log("#2", brideMotherName);

    console.log("#3", weddingHallName);
    console.log("#3", weddingHallAddress);
    console.log("#3", weddingHallPhone);

    console.log("#4", groomContact);
    console.log("#5", brideContact);
