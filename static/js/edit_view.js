...
function editSave() {
    ...
    if (telValidator(weddingHallPhone) === false ||
        telValidator(groomContact) === false ||
        telValidator(brideContact) === false) {
        return alert('올바르지 않은 형식의 전화번호 입니다')
    }
    doc = {
...
>>>>>>> 2e7233fe724ebd077220efcf095959abf0f5d497
